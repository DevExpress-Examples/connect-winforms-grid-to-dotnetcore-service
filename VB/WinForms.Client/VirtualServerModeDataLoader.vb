    ...
    Public Class VirtualServerModeDataLoader
        ...
        Public Function GetRowsAsync(ByVal e As VirtualServerModeRowsEventArgs) As Task(Of VirtualServerModeRowsTaskResult)
            Return Task.Run(Async Function()
                ...
                Dim response = Await client.GetAsync($"{System.Configuration.ConfigurationManager.AppSettings("baseUrl")}/data/OrderItems?skip={e.CurrentRowCount}&take={BatchSize}&sortField={SortField}&sortAscending={SortAscending}")
